...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:\Users\jayak\OneDrive\Desktop\Songs","")
...
def Play():
    ...
    song=f'"C:\Users\jayak\OneDrive\Desktop\Songs"{song}'
...
def Previous():
    ...
    temp2=f'"C:\Users\jayak\OneDrive\Desktop\Songs"{temp2}'
...
def Next():
    ...
    temp=f'"C:\Users\jayak\OneDrive\Desktop\Songs"{temp}'
